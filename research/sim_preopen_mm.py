"""PRE-OPEN two-sided market making: quote BEFORE the strike is set.
...
CLIP = 20.0                            # $ per side
T_START, T_END = -600, -5      # PRE-OPEN: strike not yet set, fair value ~0.50
REQUOTE = 60
...
def main():
    ...
    json.dump(res, open(f"/tmp/claude-0/-home-user-S3/8087631e-229b-5943-8560-8dda6ec827f4/scratchpad/mmpre_{ASSET}_{DAYS}d.json", "w"))
